  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Ocorreu um problema do lado do servidor. Tente novamente ou volte ao início.
        </p>
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Controle de Inventário — Assistência Social" },
      {
        ...
        content:
          "Controle de estoque das dispensas com entradas, saídas, conferências e relatórios para impressão.",
      },
